...
public class InsertMenuEvent extends Event{
	...
	public static final EventType<InsertMenuEvent> INSERT_POWER_POINT = new EventType<>("insertPowerPointInsertMenuEvent");
	...
	public static final EventType<InsertMenuEvent> INSERT_BIBLE_VERSE = new EventType<>("insertBibleVerseInsertMenuEvent");
