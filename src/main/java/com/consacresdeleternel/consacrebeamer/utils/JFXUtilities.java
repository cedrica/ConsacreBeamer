...
public class JFXUtilities {
     ...
     * @param masker will be displayed everytime there is a running task
     */
     ...
     *
     * @param doRun
     *            This is the sepcifed task to be executed by the FX Application thread
     */
    ...
    public static String convertColorToHex(Color color) {
        String hex = String.format("#%02X%02X%02X", (int) (color.getRed() * 255), (int) (color.getGreen()
