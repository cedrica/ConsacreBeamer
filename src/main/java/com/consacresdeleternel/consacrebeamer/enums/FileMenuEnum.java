...
public enum FileMenuEnum {
	NEW_SONG("csb.fileMenu.newSong", "/icons/icons8-add-file-40.png", FileMenuEvent.NEW_SONG), SEPARATOR(
			"csb.mainContainerView.separator", "", null), INSERT_SLIDE("csb.fileMenu.insertSlide",
							...
							FileMenuEvent.CLOSE_SLIDE), SEPARATOR2("csb.mainContainerView.separator", "", null), SAVE(
									...
									FileMenuEvent.SAVE), SAVE_AS("csb.fileMenu.saveAs", "/icons/icons8-save-as-50.png",
											FileMenuEvent.SAVE_AS), NEW_SCHEDULE("csb.fileMenu.newSchedule",
													...
													FileMenuEvent.NEW_SCHEDULE), PRINT("csb.fileMenu.print",
															"/icons/icons8-print-40.png",
															FileMenuEvent.PRINT), EXIT("csb.fileMenu.exit",
																	"/icons/icons8-shutdown-40.png",
																	FileMenuEvent.EXIT_APPLICATION);
