...
public enum FileMenuEnum  {
	...
	INSERT_SLIDE("csb.fileMenu.insertSlide","/icons/icons8-add-folder-50.png",FileMenuEvent.NEW_SONG),
	CLOSE_SLIDE("csb.fileMenu.closeSlide","/icons/icons8-delete-file-40.png",FileMenuEvent.NEW_SONG),
	SEPARATOR2("csb.mainContainerView.separator","",null),
	SAVE("csb.fileMenu.save","/icons/icons8-save-48.png",FileMenuEvent.NEW_SONG),
	SAVE_AS("csb.fileMenu.saveAs","/icons/icons8-save-as-50.png",FileMenuEvent.NEW_SONG),
	NEW_SCHEDULE("csb.fileMenu.newSchedule","/icons/icons8-health-calendar-40.png",FileMenuEvent.NEW_SONG),
	PRINT("csb.fileMenu.print","/icons/icons8-print-40.png",FileMenuEvent.NEW_SONG),
